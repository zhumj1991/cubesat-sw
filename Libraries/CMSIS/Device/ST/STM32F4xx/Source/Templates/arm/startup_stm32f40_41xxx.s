...
; __boot_cmd_start address
; __boot_cmd_end address
;				IMPORT	||Image$$ER_BOOT_CMD$$Base||
;				IMPORT	||Image$$ER_BOOT_CMD$$Limit||
;__boot_cmd_start
;				DCD		||Image$$ER_BOOT_CMD$$Base||

;__boot_cmd_end
;				DCD		||Image$$ER_BOOT_CMD$$Limit||
;				EXPORT  __boot_cmd_start
;				EXPORT  __boot_cmd_end

				IMPORT	||Image$$ER_ROM1$$Base||
				IMPORT	||Image$$ER_ROM1$$Length||
					
				EXPORT  __code_start
				EXPORT	__code_length
__code_start
				DCD		||Image$$ER_ROM1$$Base||
__code_length
				DCD		||Image$$ER_ROM1$$Length||
